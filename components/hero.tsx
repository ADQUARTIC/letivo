      ...
      <div className="container mx-auto px-4 sm:px-6 lg:px-8">
        <div className="grid grid-cols-1 lg:grid-cols-2 gap-12 items-center">
          <div className="space-y-6">
            <p className="text-brand-primary font-semibold tracking-[0.2em] text-sm">» CONSULTING AGENCY</p>
            <h1 className="text-4xl md:text-5xl lg:text-6xl font-extrabold leading-tight tracking-tighter text-black">
              <span className="text-brand-primary">Grow</span> with Smart <br />
              Strategy & Innovation
            </h1>
            <p className="text-gray-600 max-w-lg text-lg">
              We offer expert consulting to help organisations improve performance, build scalable solutions, and
          ...
          <div className="flex justify-center lg:justify-end">
            <Image
              ...
              alt="Professional Black business team in strategic meeting around conference table"
              width={600}
              height={500}
